...
import '/privet/accounting_post/accounting_post_widget.dart';
...
class AccountingWidget extends StatefulWidget {
  ...
  static String routeName = 'accounting';
  static String routePath = '/accounting';
...
class _AccountingWidgetState extends State<AccountingWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<AccontingRecord>>(
      stream: queryAccontingRecord(),
      builder: (context, snapshot) {
        ...
        List<AccontingRecord> accountingAccontingRecordList = snapshot.data!;
                        ...
                        Expanded(
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                5.0, 0.0, 5.0, 0.0),
                            child: StreamBuilder<List<AccontingRecord>>(
                              stream: queryAccontingRecord(),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                ...
                                List<AccontingRecord>
                                    textFieldAccontingRecordList =
                                    snapshot.data!;
                          ...
                          children: [
                            Container(
                              ...
                              child: Visibility(
                                ...
                                child: StreamBuilder<List<AccontingRecord>>(
                                  stream: queryAccontingRecord(
                                    queryBuilder: (accontingRecord) =>
                                        accontingRecord.orderBy('centerName'),
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemCount:
                                          listViewAccontingRecordList.length,
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewAccontingRecord =
                                            listViewAccontingRecordList[
                                                listViewIndex];
                                        return Padding(
                                          padding:
