...
class IctRecord extends FirestoreRecord {
  IctRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('ict');

  static Stream<IctRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => IctRecord.fromSnapshot(s));

  static Future<IctRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => IctRecord.fromSnapshot(s));

  static IctRecord fromSnapshot(DocumentSnapshot snapshot) => IctRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static IctRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      IctRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'IctRecord(reference: ${reference.path}, data: $snapshotData)';
...
Map<String, dynamic> createIctRecordData({
  String? sirName,
...
class IctRecordDocumentEquality implements Equality<IctRecord> {
  const IctRecordDocumentEquality();

  @override
  bool equals(IctRecord? e1, IctRecord? e2) {
  ...
  @override
  int hash(IctRecord? e) => const ListEquality().hash([
        e?.sirName,
        e?.sirEducationQua,
        e?.address,
        e?.gMap,
  ...
  @override
  bool isValidKey(Object? o) => o is IctRecord;
}
