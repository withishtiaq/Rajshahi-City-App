...
class PhysicsRecord extends FirestoreRecord {
  PhysicsRecord._(
  ...
  static Stream<PhysicsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => PhysicsRecord.fromSnapshot(s));

  static Future<PhysicsRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => PhysicsRecord.fromSnapshot(s));

  static PhysicsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      PhysicsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static PhysicsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      PhysicsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'PhysicsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is PhysicsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createPhysicsRecordData({
  String? sirName,
...
class PhysicsRecordDocumentEquality implements Equality<PhysicsRecord> {
  const PhysicsRecordDocumentEquality();

  @override
  bool equals(PhysicsRecord? e1, PhysicsRecord? e2) {
  ...
  @override
  int hash(PhysicsRecord? e) => const ListEquality().hash([
        e?.sirName,
        e?.sirEducationQua,
        e?.address,
        e?.gMap,
  ...
  @override
  bool isValidKey(Object? o) => o is PhysicsRecord;
}
