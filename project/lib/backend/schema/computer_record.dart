...
class ComputerRecord extends FirestoreRecord {
  ComputerRecord._(
  ...
  static Stream<ComputerRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => ComputerRecord.fromSnapshot(s));

  static Future<ComputerRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => ComputerRecord.fromSnapshot(s));

  static ComputerRecord fromSnapshot(DocumentSnapshot snapshot) =>
      ComputerRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static ComputerRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      ComputerRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'ComputerRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is ComputerRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createComputerRecordData({
  String? sirName,
...
class ComputerRecordDocumentEquality implements Equality<ComputerRecord> {
  const ComputerRecordDocumentEquality();

  @override
  bool equals(ComputerRecord? e1, ComputerRecord? e2) {
  ...
  @override
  int hash(ComputerRecord? e) => const ListEquality().hash([
        e?.sirName,
        e?.sirEducationQua,
        e?.address,
        e?.gMap,
  ...
  @override
  bool isValidKey(Object? o) => o is ComputerRecord;
}
