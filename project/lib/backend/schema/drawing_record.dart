...
class DrawingRecord extends FirestoreRecord {
  DrawingRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('drawing');

  static Stream<DrawingRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => DrawingRecord.fromSnapshot(s));

  static Future<DrawingRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => DrawingRecord.fromSnapshot(s));

  static DrawingRecord fromSnapshot(DocumentSnapshot snapshot) =>
      DrawingRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static DrawingRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      DrawingRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'DrawingRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is DrawingRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createDrawingRecordData({
  String? sirName,
...
class DrawingRecordDocumentEquality implements Equality<DrawingRecord> {
  const DrawingRecordDocumentEquality();

  @override
  bool equals(DrawingRecord? e1, DrawingRecord? e2) {
  ...
  @override
  int hash(DrawingRecord? e) => const ListEquality().hash([
        e?.sirName,
        e?.sirEducationQua,
        e?.address,
        e?.gMap,
  ...
  @override
  bool isValidKey(Object? o) => o is DrawingRecord;
}
