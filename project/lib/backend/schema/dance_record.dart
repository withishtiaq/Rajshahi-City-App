...
class DanceRecord extends FirestoreRecord {
  DanceRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('dance');

  static Stream<DanceRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => DanceRecord.fromSnapshot(s));

  static Future<DanceRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => DanceRecord.fromSnapshot(s));

  static DanceRecord fromSnapshot(DocumentSnapshot snapshot) => DanceRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static DanceRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      DanceRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'DanceRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is DanceRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createDanceRecordData({
  String? sirName,
...
class DanceRecordDocumentEquality implements Equality<DanceRecord> {
  const DanceRecordDocumentEquality();

  @override
  bool equals(DanceRecord? e1, DanceRecord? e2) {
  ...
  @override
  int hash(DanceRecord? e) => const ListEquality().hash([
        e?.sirName,
        e?.sirEducationQua,
        e?.address,
        e?.gMap,
  ...
  @override
  bool isValidKey(Object? o) => o is DanceRecord;
}
