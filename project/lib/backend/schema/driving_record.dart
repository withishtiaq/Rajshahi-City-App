...
class DrivingRecord extends FirestoreRecord {
  DrivingRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('driving');

  static Stream<DrivingRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => DrivingRecord.fromSnapshot(s));

  static Future<DrivingRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => DrivingRecord.fromSnapshot(s));

  static DrivingRecord fromSnapshot(DocumentSnapshot snapshot) =>
      DrivingRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static DrivingRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      DrivingRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'DrivingRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is DrivingRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createDrivingRecordData({
  String? sirName,
...
class DrivingRecordDocumentEquality implements Equality<DrivingRecord> {
  const DrivingRecordDocumentEquality();

  @override
  bool equals(DrivingRecord? e1, DrivingRecord? e2) {
  ...
  @override
  int hash(DrivingRecord? e) => const ListEquality().hash([
        e?.sirName,
        e?.sirEducationQua,
        e?.address,
        e?.gMap,
  ...
  @override
  bool isValidKey(Object? o) => o is DrivingRecord;
}
