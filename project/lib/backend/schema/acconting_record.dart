...
class AccontingRecord extends FirestoreRecord {
  AccontingRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('acconting');

  static Stream<AccontingRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => AccontingRecord.fromSnapshot(s));

  static Future<AccontingRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => AccontingRecord.fromSnapshot(s));

  static AccontingRecord fromSnapshot(DocumentSnapshot snapshot) =>
      AccontingRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static AccontingRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      AccontingRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'AccontingRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is AccontingRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createAccontingRecordData({
  String? sirName,
...
class AccontingRecordDocumentEquality implements Equality<AccontingRecord> {
  const AccontingRecordDocumentEquality();

  @override
  bool equals(AccontingRecord? e1, AccontingRecord? e2) {
  ...
  @override
  int hash(AccontingRecord? e) => const ListEquality().hash([
        e?.sirName,
        e?.sirEducationQua,
        e?.address,
        e?.gMap,
  ...
  @override
  bool isValidKey(Object? o) => o is AccontingRecord;
}
