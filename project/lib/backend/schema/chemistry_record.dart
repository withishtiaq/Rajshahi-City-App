...
class ChemistryRecord extends FirestoreRecord {
  ChemistryRecord._(
  ...
  static Stream<ChemistryRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => ChemistryRecord.fromSnapshot(s));

  static Future<ChemistryRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => ChemistryRecord.fromSnapshot(s));

  static ChemistryRecord fromSnapshot(DocumentSnapshot snapshot) =>
      ChemistryRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static ChemistryRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      ChemistryRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'ChemistryRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is ChemistryRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createChemistryRecordData({
  String? sirName,
...
class ChemistryRecordDocumentEquality implements Equality<ChemistryRecord> {
  const ChemistryRecordDocumentEquality();

  @override
  bool equals(ChemistryRecord? e1, ChemistryRecord? e2) {
  ...
  @override
  int hash(ChemistryRecord? e) => const ListEquality().hash([
        e?.sirName,
        e?.sirEducationQua,
        e?.address,
        e?.gMap,
  ...
  @override
  bool isValidKey(Object? o) => o is ChemistryRecord;
}
