...
class MathRecord extends FirestoreRecord {
  MathRecord._(
  ...
  static Stream<MathRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => MathRecord.fromSnapshot(s));

  static Future<MathRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => MathRecord.fromSnapshot(s));

  static MathRecord fromSnapshot(DocumentSnapshot snapshot) => MathRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static MathRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      MathRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'MathRecord(reference: ${reference.path}, data: $snapshotData)';
...
Map<String, dynamic> createMathRecordData({
  String? sirName,
...
class MathRecordDocumentEquality implements Equality<MathRecord> {
  const MathRecordDocumentEquality();

  @override
  bool equals(MathRecord? e1, MathRecord? e2) {
  ...
  @override
  int hash(MathRecord? e) => const ListEquality().hash([
        e?.sirName,
        e?.sirEducationQua,
        e?.address,
        e?.gMap,
  ...
  @override
  bool isValidKey(Object? o) => o is MathRecord;
}
