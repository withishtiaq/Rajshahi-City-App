...
class SingRecord extends FirestoreRecord {
  SingRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('sing');

  static Stream<SingRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => SingRecord.fromSnapshot(s));

  static Future<SingRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => SingRecord.fromSnapshot(s));

  static SingRecord fromSnapshot(DocumentSnapshot snapshot) => SingRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static SingRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      SingRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'SingRecord(reference: ${reference.path}, data: $snapshotData)';
...
Map<String, dynamic> createSingRecordData({
  String? sirName,
...
class SingRecordDocumentEquality implements Equality<SingRecord> {
  const SingRecordDocumentEquality();

  @override
  bool equals(SingRecord? e1, SingRecord? e2) {
  ...
  @override
  int hash(SingRecord? e) => const ListEquality().hash([
        e?.sirName,
        e?.sirEducationQua,
        e?.address,
        e?.gMap,
  ...
  @override
  bool isValidKey(Object? o) => o is SingRecord;
}
