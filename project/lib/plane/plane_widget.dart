...
export 'plane_model.dart';

class PlaneWidget extends StatefulWidget {
  const PlaneWidget({super.key});

  static String routeName = 'plane';
  static String routePath = '/plane';
...
class _PlaneWidgetState extends State<PlaneWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlaneModel());
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                'রাজশাহী হতে ঢাকা বিমানের সিডিউল',
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.asset(
                                            'assets/images/Screenshot_2025-03-12_201950.png',
                                            width: 224.07,
                                            height: 200.0,
                                            fit: BoxFit.contain,
                                          ),
                                            ...
                                            child: RichText(
                                              ...
                                              text: TextSpan(
                                                children: [
                                                  ...
                                                  TextSpan(
                                                    text:
                                                        '\n (দিন অনুযায়ী ভ্যারি করে) ',
                                                    style:
                                                        GoogleFonts.tiroBangla(
                                                      color: Color(0xFFF01337),
                                                      fontWeight:
                                                          FontWeight.w600,
                                                      fontSize: 12.0,
                                                    ),
                                      ...
                                      child: Container(
                                        ...
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(8.0),
                                          child: Image.asset(
                                            'assets/images/669690c41c244cd0873e5e8d.png',
                                            width: 224.07,
                                            height: 200.0,
                                            fit: BoxFit.contain,
                                          ),
                                      ...
                                      child: Container(
                                        ...
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(8.0),
                                          child: Image.asset(
                                            'assets/images/Novo_Air_Office_in_Bangladesh.png',
                                            width: 224.07,
                                            height: 200.0,
                                            fit: BoxFit.contain,
                                          ),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed(PlaneTICKTWidget.routeName);
                            },
                            text: 'টিকিট কিনুন ',
                            icon: Icon(
                              Icons.shopping_cart,
