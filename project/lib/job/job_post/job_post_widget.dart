...
class _JobPostWidgetState extends State<JobPostWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JobPostModel());
