...
import '/hotel/hotelpost/hotelpost_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<HotelRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<HotelRecord> hotelHotelRecordList = snapshot.data!;
                          ...
                          child: Padding(
                            ...
                            child: StreamBuilder<List<HotelRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<HotelRecord> textFieldHotelRecordList =
                                    snapshot.data!;
                          ...
                          children: [
                            Container(
                              ...
                              child: Visibility(
                                ...
                                child: StreamBuilder<List<HotelRecord>>(
                                  stream: queryHotelRecord(
                                    queryBuilder: (hotelRecord) =>
                                        hotelRecord.orderBy('hotelName'),
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
